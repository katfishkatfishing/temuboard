...
**Date: July 16th**
- I went to https://www.keyboard-layout-editor.com to figure out what layout i wanted, im currently using a 60%, and i really needed function keys and the arrow keys
so i picked the Keycool84, and slightly modified it.

$$\color{red}{**Total \space hours: \space 1**}$$

<img width="884" height="344" alt="keyboard-layout" src="https://github.com/user-attachments/assets/bddb1b48-9e1e-4011-a9bd-43534cc8d2d9" />
https://lapse.hackclub.com/timelapse/-kUr7TK3-eP2
...
**Date: July 20th**
- same as header, moved around components and tried to gather as much space as possible for the mcu and traces
...
$$\color{red}{**Total \space hours: \space 6**}$$
...
**Date: July 21st**
- routing traces ahhhhhhh, then spent 2 hours figuring out how to even use freeeeecad

$$\color{red}{**Total \space hours: \space 5(3+2)**}$$
...
$$\color{red}{**Total \space hours: \space 3**}$$
...
**Date: July 23rd**
- Spent the entire day adding switch and keycap 3d model to the switches, this took me so long 
...
$$\color{red}{**Total \space hours: \space 3.5**}$$
...
**Date: July 24th**
- My rotary encoder was wayy too close to the keys so i had to move some components to make space, and then moved the usbc receptacle to a better spot
then worked a bit on the case
...
then i also picked the bottom mount at this point since i dont need the gasket mount silence.
...
## Entry 13 - More CAD
**Date: July 27th**
- More cad, kinda know how to use freecad now, added holes to the plate for the display and the rotary encoder. reaching abt 70% done for the case

$$\color{red}{**Total \space hours: \space 3**}$$

<img width="1919" height="973" alt="image" src="https://github.com/user-attachments/assets/c14bf2c2-1264-4dcd-8d1e-a63a98da94d3" />
<img width="510" height="279" alt="image" src="https://github.com/user-attachments/assets/6da99a6e-a217-414b-b50b-1074666e9dc3" />
...
freecad freezes for like a minute, i had like 700 elements in that sketch, so it lagged like hell, i didnt have any other solutions for this so i kept going for
3 hours
...
**Date: July 28th**
- im still working on the plate, the sketch isnt finished, so i kept going until it couldnt hold it anymore, and then found out i could combine sketches, so i made
a second one, but when i combined them it doesnt include the imported geometry, devestated 

$$\color{red}{**Total \space hours: \space 5.5**}$$

<img width="1159" height="561" alt="image" src="https://github.com/user-attachments/assets/786705e0-bbf1-461f-98ab-9ac2f51a7bd4" />
<img width="1919" height="1079" alt="image" src="https://github.com/user-attachments/assets/dd9b9a2c-f851-4999-95fd-d0d780f163c2" />
...
deleted an element, the entire thing goes, i have no idea why and no idea how to replicate it, i worked around it since it was what i needed, finished up the
plate, then aligned the plate, pcb and the case bottom, and finding out the usbc receptacle is in between everything

$$\color{red}{**Total \space hours: \space 2.5**}$$
...
**Date: July 29th**
- added indents to bottom case to screw in the plate, then added screw mounts to bottom case. then i rerouted the usbc receptacle cuz i had to flip it to the back,
it was either hell to cad since the receptacle was in between everything, or hell in pcb cuz the d+/d- lines are crossed when the receptacle is flipped to the back

$$\color{red}{**Total \space hours: \space 4**}$$

<img width="882" height="492" alt="image" src="https://github.com/user-attachments/assets/2708551f-6f82-4b17-ba93-6395863ea620" />

- asking my friend if this was ok lol
...
much cuz it was just freecad freezing

$$\color{red}{**Total \space hours: \space 0.5**}$$
...
**Date: July 30th**
- found out i could offset the sketches, reach enlightenment and be able to make shapes i wanted to make but couldnt before, added screw mounts to plate and case 
top, then made the case bottom look better, and added fillets
...
**Date: July 31st**
- originally wanted to start doing the firmware but i have no idea how to do that so i decided to start working on the repo. hello, me in the present.
uploaded files to the repo, updated the readme, and started writing this. i forgot to journal along the way so im only doing it now.

$$\color{red}{**Total \space hours: \space 3**}$$

<img width="1402" height="761" alt="image" src="https://github.com/user-attachments/assets/3564e995-0900-4e89-9d5c-16d4faddc1a0" />
<img width="1320" height="772" alt="image" src="https://github.com/user-attachments/assets/94db94fd-d6d3-426d-b077-10c74e35f809" />
